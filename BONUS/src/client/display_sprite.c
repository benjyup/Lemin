...
** Last update Fri Apr 22 17:23:11 2016 Timothée Puentes
*/
				       ...
				       int avance)
{
  ...
  spri.x = ((avance % ANIM_SPEED) * SPRITE_X) % sprite->clipable.clip_width;
  spri.y = ((avance % ANIM_SPEED) * SPRITE_X) / sprite->clipable.clip_width * SPRITE_Y;
